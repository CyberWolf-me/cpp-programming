...
public:
    ...
    void give()
    {
        ...
        while (m)
        {
            cout << "\n\n";
            center();
            cout << "****We are sorry, but a user with this Email-Id is already registresed\n";
            center();
            cout << "Please enter another Email-Id: ";
            cin.getline(emailid, 50);
            m = r10.uniqueid(emailid);
        }
        cout << "\n";
    ...
    void showresult(void)
    {
        ...
        if (getch())
        {
            ...
            cout << "Incorrect Answers : " << incorrect << endl
                 << endl;
            center();
            cout << "Unattempted Answers: " << unattempted << endl
                 << endl
                 << endl;
            decl();
            decl();
...
void questions(char *name)
{
    ...
    decl();
    center();
    cout << "***You can give a test only once***\n";
    center();
    cout << "PRESS 1. TO GIVE C++ TEST\n";
    center();
    cout << "PRESS 2.TO GIVE PYTHON TEST\n";
    center();
    cout << "PRESS3.TO GIVE DATA STRUCTURES(DSA) TEST\n";
    cout << "\n\n\n\n";
    center();
    cout << "ENTER YOUR CHOICE FOR TEST: ";
    cin >> choice;
...
int instructionblock()
{
    ...
    center();
    cout << "6.MAXIMISE YOUR WINDOW OTHERWISE YOU MAY GET DIFFICULTY\n";
    return 0;
}
...
void resultdisplay()
{
    ...
    cout << "\n\n\n";
    center();
    cout << "PRESS 1. TO SEE C++ RESULT.\n";
    center();
    cout << "PRESS 2. TO SEE PYTHON RESULT.\n";
    center();
    cout << "PRESS 3. TO SEE DATA STRUCTURES RESULT.\n";
    center();
    ...
    case 1:
        result r1;
        center();
        cout << "***Enter Your Login ID to See you C++ result: ";
        char na[20];
        cin.ignore();
        cin.getline(na, 20);
    ...
    case 2:
        result r2;
        center();
        cout << "***Enter Your Login ID to See you Python result: ";
        char pa[20];
        cin.ignore();
        cin.getline(pa, 20);
    ...
    case 3:
        result r3;
        center();
        cout << "***Enter Your Login ID to See you DS result: ";
        char da[20];
        cin.ignore();
        cin.getline(da, 20);
    ...
    do
    {
...

        {
            ...
            case 4:
                ...
                center();
                cout << "TO KNOW FUTHER ABOUT TEST DETAILS ENTER YOUR CHOICE ACCORDING TO ABOVE CHOICES : ";
                int c;
                cin >> c;
                ...
                case 1:
                    ...
                    center();
                    cout << " Prees 0 to exit from program: ";
                    int c4;
                    cin >> c4;
                    if (c4 == 1)
                    {
